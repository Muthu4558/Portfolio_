...
export { default as project1 } from "./work/project1.png";
export { default as project2 } from "./work/project2.png";
export { default as project3 } from "./work/project3.png";
export { default as project4 } from "./work/project4.png";
